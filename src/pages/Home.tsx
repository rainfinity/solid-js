...
const Home: Component = () => (
    <DefaultLayout>
        ...
        <div className="mt-5 flex gap-4">
            <button
                class="bg-blue-700 text-white px-2 py-1 rounded-md"
                onClick={() => handleAlert({ type: 'default', text: 'Wohoo!' })}
            >
                Show Alert
            </button>
            <button
                class="bg-green-700 text-white px-2 py-1 rounded-md"
                onClick={() => handleAlert({ type: 'success', text: 'Yesssss!' })}
            >
                Show Success
            </button>
            <button
                class="bg-red-700 text-white px-2 py-1 rounded-md"
                onClick={() => handleAlert({ type: 'error', text: 'Ewwwww!' })}
            >
                Show Error
            </button>
        </div>
