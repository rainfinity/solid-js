    ...
    async function updProfile({ username, website }: Omit<ProfileAttrs, 'avatar_url'>) {
        try {
            ...
            const {
                data: [updates],
                error: updateError,
            } = await updCurrUserProfile({ username, website });
            if (updateError) {
                throw updateError;
            }
    ...
    return (
        <PrivateLayout>
            ...
            <div class="p-2 flex flex-col place-items-center">
                ...
                <Show when={!loading()}>
                    <div
                        class="profile-detail my-4 flex flex-col place-items-center"
                        ...
                        <div class="modal-box w-full">
                            <form class="" onSubmit={handleSubmit}>
                                ...
                                <div class="modal-action">
                                    <button type="submit" class="btn btn-primary" disabled={isProfileUpdating()}>
                                        Update Profile
                                    </button>
                                    <button class="btn" onClick={() => setIsModalOpened(false)}>
                                        Close
                                    </button>
                                </div>
                            </form>
