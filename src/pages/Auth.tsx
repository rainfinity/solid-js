...
const Auth: Component = () => {
    ...
    createEffect(() => {
        isLogIn() ? setCurrActionLabel('Sign In') : setCurrActionLabel('Sign Up');
    });
    ...
    return (
        <DefaultLayout>
            <Title>Profile</Title>
            <h1 class="text-4xl font-semibold text-blue-900 w-full text-center mb-2 mt-16">{currActionLabel}</h1>
                    ...
                    <div class="card-body">
                        <div className="form-controls">
                            <div class="form-control mt-6">
                                <button
                                    type="submit"
                                    class="btn bg-white text-green-800 border-primary hover:bg-green-800 hover:text-white"
                                    onClick={(e) => {
                                        e.preventDefault();
                        ...
                        <label class="label inline-block text-center w-full">
                            <a href="#" class="label-text-alt" onClick={toggleAuth}>
